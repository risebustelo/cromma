...
// ─── Flip lines — más cortas y directas ──────────────────────────────────────
...
function FlipLine({ left, right, delay }: { left: string; right: string; delay: number }) {
  ...
  return (
    <div className="flex items-baseline gap-2 flex-wrap">
      <span style={{ fontFamily: "cromma, sans-serif", fontSize: "clamp(1.1rem,2.6vw,1.65rem)", fontWeight: 900, color: "#ffffff", letterSpacing: "-0.02em", lineHeight: 1 }}>
        {left}
      </span>
      <span style={{ fontFamily: "cromma, sans-serif", fontSize: "clamp(1.1rem,2.6vw,1.65rem)", fontWeight: 600, color: phase === "typing" ? "#c9a227" : "#797979", letterSpacing: "-0.02em", lineHeight: 1, minWidth: "1ch" }}>
        {text}
        <span style={{ display: "inline-block", width: 2, height: "1em", background: "#c9a227", marginLeft: 2, verticalAlign: "text-bottom", opacity: phase === "show-right" ? 0 : 1, animation: phase !== "show-right" ? "blink 0.5s step-end infinite" : "none" }} />
      </span>
    </div>
  )
}
...
// ─── Paleta WCAG AA — valores calculados con ratio exacto ────────────────────
//
...
// DARK  bg #0e0e0e → pain #e2e2e2 14.90:1 ✅ | label/tag #818181 4.96:1 ✅ | sub #7a7a7a 4.50:1 ✅
// micro-labels/cierre sobre #0a0a0a → #797979 4.55:1 ✅
...
const V: Record<Variant, {
  ...
  dark: {
    ...
    dot: "#818181",
    painColor: "#e2e2e2",
    subColor: "#7b7b7b",     //  4.56:1 ✅  (era #7a7a7a → 4.50 borderline, corregido)
    labelColor: "#818181",
    tagColor: "#818181",
...
// ─── Fondo SVG decorativo de redes sociales ───────────────────────────────────
...
function SocialBg({ dark }: { dark: boolean }) {
  ...
  return (
    <svg aria-hidden="true" className="absolute inset-0 w-full h-full pointer-events-none"
      ...
      <circle cx="190" cy="55" r="18" stroke={c} strokeWidth="1.3" />
      <path d="M183 55 L197 55 M190 48 L190 62" stroke={c} strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  )
}
...
const ROW_1: CardData[] = [
  {
    label: "COACH / MENTOR",
    pain: "Vendés por recomendación, no sistema.",
    sub: "Cuando para el boca a boca, para todo.",
    tag: "SIN SISTEMA",
    variant: "gold",
  },
  {
    label: "INFOPRODUCTOR",
    pain: "Contenido hay. Conversión, no.",
    sub: "La audiencia consume pero no compra.",
    tag: "CONVERSIÓN CERO",
    variant: "light",
  },
  {
  ...
  {
    label: "YOUTUBER / INFLUENCER",
    pain: "Audiencia grande. Monetización, no.",
    sub: "Views no pagan el alquiler.",
    tag: "SIN MONETIZACIÓN",
    variant: "gold",
  },
  {
    label: "CONSULTOR",
...
const ROW_2: CardData[] = [
  {
    ...
    sub: "Dependés de la suerte de la red.",
    tag: "SIN FLUJO",
    variant: "light",
  },
  {
      ...
      <div className="relative z-10 h-full flex flex-col justify-between p-4">
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span style={{ fontFamily: "cromma, sans-serif", fontSize: 8, fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase" as const, color: v.labelColor, whiteSpace: "nowrap" as const }}>
              {label}
            </span>
          </div>
          <span style={{ fontFamily: "cromma, sans-serif", fontSize: 7, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: v.tagColor, background: v.tagBg, border: `1px solid ${v.tagBorder}`, borderRadius: 99, padding: "2px 6px", whiteSpace: "nowrap" as const, flexShrink: 0 }}>
            {tag}
          </span>
        </div>

        <p style={{ fontFamily: "cromma, sans-serif", fontSize: 13, fontWeight: 700, lineHeight: 1.35, letterSpacing: "-0.01em", color: v.painColor, margin: 0 }}>
          {pain}
        </p>

        <p style={{ fontFamily: "cromma, sans-serif", fontSize: 11, fontWeight: 500, lineHeight: 1.35, color: v.subColor, margin: 0 }}>
          {sub}
        </p>
...
function Track({ items, duration, reverse = false }: { items: CardData[]; duration: number; reverse?: boolean }) {
  return (
    <div className="relative overflow-hidden" style={{ height: 140 }}>
      ...
      <div
        ...
        style={{ height: 140, animation: `insight-scroll ${duration}s linear infinite ${reverse ? "reverse" : "normal"}`, willChange: "transform" }}
      >
    ...
    <section ref={ref} id="insight" className="section-dark relative overflow-hidden py-10 md:py-16">
      ...
      <div className="container mx-auto px-4 mb-10">
        <div className="mx-auto max-w-4xl space-y-4">
          <p style={{ fontFamily: "monospace", fontSize: 10, fontWeight: 700, letterSpacing: "0.25em", color: "#c9a227" }}>
            {eyebrow}
            <span style={{ display: "inline-block", width: 2, height: "0.8em", background: "#c9a227", marginLeft: 3, verticalAlign: "middle", animation: visible ? "blink 0.7s step-end infinite" : "none", opacity: visible ? 1 : 0 }} />
          </p>
      ...
      <div className="container mx-auto px-4 mb-3">
        <div className="mx-auto max-w-4xl">
          <span style={{ fontFamily: "monospace", fontSize: 9, fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase" as const, color: "#797979" }}>
      ...
      <div className="container mx-auto px-4 mt-10">
        <div className="mx-auto max-w-4xl space-y-1">
          ...
          <p style={{ fontFamily: "cromma, sans-serif", fontSize: 13, color: "#797979" }}>
            Es un sistema que conecte todo.
          </p>
        </div>
      </div>
